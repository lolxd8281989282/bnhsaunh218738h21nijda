return function(Library, ESP)
    ...
    :Colorpicker({Info = "ESP Color", Default = Color3.fromRGB(255, 192, 203)})

    -- Box with type selection
    ...
    :Colorpicker({Info = "Box Color", Default = Color3.fromRGB(255, 192, 203)})
    ...
    PlayerESP:Dropdown({
        ...
        callback = function(value)
            if ESP then
                ESP.BoxType = value:lower()
            end
        end
    })

    -- Create ESP features with proper callbacks
    ...
    createESPFeature("distance", "Distance", Color3.fromRGB(0, 255, 255))
    createESPFeature("weapon", "Weapon", Color3.fromRGB(0, 255, 255))
    createESPFeature("skeleton", "Bone", Color3.fromRGB(255, 255, 0))
