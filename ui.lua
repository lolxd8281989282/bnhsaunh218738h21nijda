return function(Window, Library, ESP)
    ...
    ESP:Toggle({Name = "Bone", Default = false, Pointer = "ESP_Bone", callback = function(value)
        ESP.ShowBone = value
    end})
    ...
    :Colorpicker({Info = "Health Bar Color", Default = Color3.fromRGB(127, 255, 0), Pointer = "ESP_HealthBarColor", callback = function(value)
        ESP.HealthBarColor = value
    end})
    ESP:Toggle({Name = "Armor Bar", Default = false, Pointer = "ESP_ArmorBar", callback = function(value)
    ...
    ESP:Toggle({Name = "Weapon", Default = false, Pointer = "ESP_Weapon", callback = function(value)
    ...
    ESP:Toggle({Name = "Flags", Default = false, Pointer = "ESP_Flags", callback = function(value)
        ESP.ShowFlags = value
    end})
    ...
    ESP:Toggle({Name = "Bullet Tracers", Default = false, Pointer = "ESP_BulletTracers", callback = function(value)
