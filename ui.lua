return function(Library, ESP)
  ...
  -- // Target Aim Section
  TargetAim:Toggle({Name = "Enabled", Default = false, Pointer = "TargetEnabled", callback = function(value)
  ...
  TargetAim:Toggle({Name = "Index (Mouse M1)", Default = false, Pointer = "TargetIndex", callback = function(value)
      -- Add your callback logic here
  end})
  TargetAim:Toggle({Name = "Notifications", Default = false, Pointer = "TargetNotifications", callback = function(value)
      -- Add your callback logic here
  end})
  TargetAim:Toggle({Name = "Resolver", Default = false, Pointer = "TargetResolver", callback = function(value)
      -- Add your callback logic here
  end})
  ...
  FOV:Toggle({Name = "Visible", Default = false, Pointer = "FOVVisible", callback = function(value)
      -- Add your callback logic here
  end})
  FOV:Toggle({Name = "Filled", Default = false, Pointer = "FOVFilled", callback = function(value)
      -- Add your callback logic here
  end})
  ...
  FOV:Toggle({Name = "Auto Select", Default = false, Pointer = "FOVAutoSelect", callback = function(value)
      -- Add your callback logic here
  end})
